...
// 2019-09-18 19:10:02.516958 -0300 -03 m=&#43;0.002396509
...
func EtherClassic() Coin {
	return Coins[ETC]
}
func ICON() Coin {
	return Coins[ICX]
}
func CosmosATOM() Coin {
	return Coins[ATOM]
}
func Ripple() Coin {
	return Coins[XRP]
}
func StellarLumens() Coin {
	return Coins[XLM]
}
func Poa() Coin {
	return Coins[POA]
