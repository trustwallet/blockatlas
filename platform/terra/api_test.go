...
var transferDst = blockatlas.Tx{
	...
	Type:   blockatlas.TxMultiCoinTransfer,
	Meta: blockatlas.MultiCoinTransfer{
		Coins: []blockatlas.Transfer{
			blockatlas.Transfer{
...
var delegateDst = blockatlas.Tx{
	...
	Block:     311067,
	Status:    blockatlas.StatusCompleted,
	Type:      blockatlas.TxMultiCoinAnyAction,
	Direction: blockatlas.DirectionOutgoing,
	Meta: blockatlas.MultiCoinAnyAction{
