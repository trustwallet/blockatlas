...
var (
	...
	transferSrcKava, _   = mock.JsonFromFilePathToString("mocks/" + "transfer_kava.json")
	failedTransferSrc, _ = mock.JsonFromFilePathToString("mocks/" + "transfer_failed.json")
	delegateSrc, _       = mock.JsonFromFilePathToString("mocks/" + "delegate_tx.json")
	unDelegateSrc, _     = mock.JsonFromFilePathToString("mocks/" + "undelegate_tx.json")
	claimRewardSrc1, _   = mock.JsonFromFilePathToString("mocks/" + "claim_1.json")
	claimRewardSrc2, _   = mock.JsonFromFilePathToString("mocks/" + "claim_2.json")
	...
	failedTransferDst = blockatlas.Tx{
