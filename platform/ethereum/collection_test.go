...
var (
	...
	collection1DstV4 = txtype.Collection{
		Name:         "CryptoKitties",
	...
	collection2DstV4 = txtype.Collection{
		Name:         "Age of Rust",
	...
	collection3DstV4 = txtype.Collection{
		Name:         "Gods Unchained",
	...
	collectibleDstV4 = txtype.Collectible{
...
func TestNormalizeCollectionV4(t *testing.T) {
	...
	expected := txtype.CollectionPage{collection1DstV4, collection2DstV4, collection3DstV4}
...
func TestNormalizeCollectibleV4(t *testing.T) {
	...
	expected := txtype.CollectiblePage{collectibleDstV4}
