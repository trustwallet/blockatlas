...
func TestCMockAccount(t *testing.T) {
	tests := []struct {
		...
		{"60", CMAccountRequest{[]string{"0x12560000"}}, `{"accounts":[{"address":"0x12560000","tokens":[{"address":"0x6aabbcc000002","symbol":"USDC","supply_balance_underlying":1001.25,"lifetime_supply_interest_accrued":2.25}]}]}`},
		{"40", CMAccountRequest{[]string{"0x12540000"}}, `{"accounts":[{"address":"0x12540000","tokens":[]}]}`},
