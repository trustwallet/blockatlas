...
func NormalizeValidator(plainValidator blockatlas.Validator, validator AssetValidator, coin coin.Coin) blockatlas.StakeValidator {
	...
	stakingDetails.Reward.Annual = calculateAnnual(stakingDetails.Reward.Annual, validator.Payout.Commission)
...
func calculateAnnual(coinAnnual float64, commission float64) float64 {
