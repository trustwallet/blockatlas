...
// 2019-11-19 23:00:57.410847 +0800 WITA m=+0.125550189
    ...
    "paths": {
        ...
        "/v2/ns/lookup": {
            "post": {
                ...
                "operationId": "naming_service",
                "parameters": [
                    {
                        "description": "ns name and coins",
                        "name": "coins",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/api.ENSBatchRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.LookupBatchPage"
                        }
                    }
                }
            }
