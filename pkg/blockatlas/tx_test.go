...
var (
	beforeTransactionsToken, _ = mock.JsonFromFilePathToString("mocks/bnb_token_txs.json")
	wantedTransactionsToken, _ = mock.JsonFromFilePathToString("mocks/bnb_token_response.json")
)
