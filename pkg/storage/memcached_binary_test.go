...
var newMcStore = func(t *testing.T, defaultExpiration time.Duration) cache.Storage {
...
var newMcStoreWithConfig = func(t *testing.T, defaultExpiration time.Duration) cache.Storage {
